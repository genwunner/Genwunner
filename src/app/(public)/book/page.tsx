      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-white/50 text-sm mb-8">
            ...
            <a href="mailto:genwunnermgmt@gmail.com" className="text-red-600 underline">genwunnermgmt@gmail.com</a>
          </p>
  ...
  return (
    <div className="min-h-screen py-20 px-4">
      <div className="max-w-2xl mx-auto">
        <p className="text-red-600 text-xs uppercase tracking-[0.3em] font-bold mb-4 text-center">Book Genwunner</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input type="text" name="venue" placeholder="Venue Name"
            className="w-full bg-zinc-900 border border-white/20 rounded-xl px-4 py-3 text-sm text-white placeholder:text-white/30 outline-none focus:border-red-600 transition-colors" />
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <textarea name="message" rows={4} placeholder="Additional notes, special requests, or details…"
            className="w-full bg-zinc-900 border border-white/20 rounded-xl px-4 py-3 text-sm text-white placeholder:text-white/30 outline-none focus:border-red-600 transition-colors resize-none" />
          ...
          <p className="text-white/20 text-xs text-center">
            For urgent inquiries: <a href="mailto:genwunnermgmt@gmail.com" className="text-red-600/50 hover:text-red-600 underline">genwunnermgmt@gmail.com</a>
          </p>
        </form>
      </div>
    </div>
